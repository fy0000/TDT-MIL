...
import numpy as np
import glob
from model.loss_acctu import plot
...
def make_parse():
    ...
    parser.add_argument('--config', default='TDTMIL.yaml',type=str)
    parser.add_argument('--gpus', default = [0])
    parser.add_argument('--fold', default = 12)
    # parser.add_argument('--nfold', default=4)
